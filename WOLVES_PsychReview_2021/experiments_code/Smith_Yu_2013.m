...
parfor subject = 1:numSubjects
    ...
    visuals_On = 1;    visuals_Off = floor(4000/scale_factor);
    
    word1_On = floor([368, 1850]/scale_factor); word1_Off = floor([368+745, 1850+745]/scale_factor); 
...
%% SY tests [8-second long]
    visuals_On = 1; visuals_Off = floor(8000/scale_factor); 
    word_On =  floor([scale_factor 1800 3500 5200 6900]/scale_factor); word_Off = floor((745+[scale_factor 1800 3500 5200 6900])/scale_factor); %XTRAP
...
%% 1-sec test   
     ...
     %word_On = floor([scale_factor]/scale_factor); word_Off =floor([1000]/scale_factor); 
