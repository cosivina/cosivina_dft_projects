...
maxFam = 3;%number of  pretrained objects
maxTR = 27; % total # of training trials
maxTRt = nObjects; % total # of test trials
t_maxF = floor((7000+1000)/scale_factor);
...
parfor subject = 1:numSubjects
 ...
 %% LEARNING PHASE   
    ...
    word1_On  = floor([2250 4500 6750 9000]/scale_factor);  
    word1_Off = floor([4450 6700 8950 11250]/scale_factor);  
