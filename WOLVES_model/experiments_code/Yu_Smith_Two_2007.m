...
t_max = floor((6000/3+1000)/scale_factor); %specify simulation time  % scale with Experiment training trial Duration   %6000
...
parfor subject = 1:numSubjects
    ...
    visuals_On = 0;
    visuals_Off=floor(6000/(3*scale_factor));
    word1_On  = floor(1000/(3*scale_factor));% word length values assumed, i could not find in the article  
