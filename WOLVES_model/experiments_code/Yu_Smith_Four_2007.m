...
t_max = floor((12000/3+1000)/scale_factor); %specify simulation time  % scale with Experiment training trial Duration   
...
parfor subject = 1:numSubjects
    ...
    visuals_On = 0;
    visuals_Off = floor((12000)/(3*scale_factor));
    word1_On  = floor(1000/(3*scale_factor));% values assumed, i could not find in the article  
    word1_Off = floor(2000/(3*scale_factor));%
    word2_On  = floor(4000/(3*scale_factor));%
    word2_Off = floor(5000/(3*scale_factor));%
    word3_On  = floor(7000/(3*scale_factor));%
    word3_Off = floor(8000/(3*scale_factor));%
    word4_On  = floor(10000/(3*scale_factor));%
    word4_Off = floor(11000/(3*scale_factor));%
...
%     Object_indH=1+mod(7:nObjects+6,nObjects);% H I J K...
